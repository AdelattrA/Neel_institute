...
filepath = []
for fn in filename:
    filepath.append("/Users/AL-nikon/Desktop/alex/mesure_masselotte_corde_vibrante/Test_amplitude/{}.txt".format(fn))
...
plt.savefig("/Users/AL-nikon/Desktop/alex/mesure_masselotte_corde_vibrante/Test_amplitude/Comparaison_amplitude.png",dpi = 300)
plt.show()
